...
bool ThreadInterlockedAssignIf128( volatile int128 *pDest, const int128 &value, const int128 &comperand )
{
	...
	const int64 *pComperand = (const int64 *)&comperand;
	const int64 *pValue = (const int64 *)&value;
	// Must copy comperand to stack because the intrinsic uses it as an in/out param
	int64 comperandInOut[2] = { pComperand[0], pComperand[1] };
	...
	if ( _InterlockedCompareExchange128( ( volatile int64 * )pDest, pValue[1], pValue[0], comperandInOut ) )
		return true;
	return false;
}
#endif
